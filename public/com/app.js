...
.controller('LogoutController',// jshint ignore:line
    ['$scope', '$rootScope', 'FoundationApi', '$location', 'AuthenticationService',
    function ($scope, $rootScope, FoundationApi, $location, AuthenticationService) {
        // reset login status
        AuthenticationService.ClearCredentials();
        FoundationApi.closeActiveElements();
        $location.path('/');
...
angular.module('myApp.module.Company.Graph.Factory', [])// jshint ignore:line
